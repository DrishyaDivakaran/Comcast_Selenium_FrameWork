...
public class EditingDescriptionInformationForProduct {
	WebDriver driver;
	@BeforeClass
	...
	driver.findElement(By.xpath("//textarea [@class='detailedViewTextBox']")).sendKeys("[[PRO10]LG123-PRODUCT INFORMATION]");
